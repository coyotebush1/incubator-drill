...
public class FixedTable extends EmptyVectorSet  {
  ...
  static private final RelDataTypeFactory typeFactory = new SqlTypeFactoryImpl();
  
  static public RelDataType getRelDataType(MajorType type) {
  ...
  public RelDataType getRowType() {
    ...
    for (int i=0; i<fieldTypes.length; i++) {
      relTypes[i] = getRelDataType(fieldTypes[i]);
    }
